...
function cityObstacles() {
  ...
  if(frameCount % 160 === 0) {
    cityobstacle = createSprite(Math.round(random(800,1600)),630,10,40);
        cityobstacle.velocityX = -6  
        cityobstacle.setCollider("rectangle",0,0,260,120) 
        cityobstacle.debug=true;
...
function forestObstacles() {
  ...
  if(frameCount % 190 === 0) {
   ...
   forestobstacle = createSprite(1500,625,10,40);
